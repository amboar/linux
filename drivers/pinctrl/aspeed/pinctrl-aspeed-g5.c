...
#define LHCR0		SIG_DESC_TO_REG(ASPEED_PINMUX_IP_LPC, 0xA0)
#define GFX064		SIG_DESC_TO_REG(ASPEED_PINMUX_IP_GFX, 0x64)
...
#define D13 2
SIG_EXPR_LIST_DECL_SINGLE(SPICS1, SPICS1, SIG_DESC_SET(SCU80, 15));
SIG_EXPR_LIST_DECL_SINGLE(TIMER3, TIMER3, SIG_DESC_SET(SCU80, 2));
MS_PIN_DECL(D13, GPIOA2, SPICS1, TIMER3);
FUNC_GROUP_DECL(SPICS1, D13);
...
FUNC_GROUP_DECL(SPI1DEBUG, B15, C15, A14, A15);
FUNC_GROUP_DECL(SPI1PASSTHRU, B15, C15, A14, A15);
