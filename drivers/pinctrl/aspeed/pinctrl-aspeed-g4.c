...
#define C22 64
SIG_EXPR_LIST_DECL_SINGLE(SYSCS, SYSSPI, SYSSPI_DESC);
SS_PIN_DECL(C22, GPIOI0, SYSCS);

#define G18 65
SIG_EXPR_LIST_DECL_SINGLE(SYSCK, SYSSPI, SYSSPI_DESC);
SS_PIN_DECL(G18, GPIOI1, SYSCK);

#define D19 66
SIG_EXPR_LIST_DECL_SINGLE(SYSDI, SYSSPI, SYSSPI_DESC);
SS_PIN_DECL(D19, GPIOI2, SYSDI);

#define C20 67
SIG_EXPR_LIST_DECL_SINGLE(SYSDO, SYSSPI, SYSSPI_DESC);
SS_PIN_DECL(C20, GPIOI3, SYSDO);

FUNC_GROUP_DECL(SYSSPI, C22, G18, D19, C20);
...
#define B22 68
SIG_EXPR_DECL(SPI1CS0, SPI1_MASTER, SPI1_MASTER_DESC);
SIG_EXPR_DECL(SPI1CS0, SPI1_DEBUG, SPI1_DEBUG_DESC);
SIG_EXPR_DECL(SPI1CS0, SPI1_PASSTHRU, SPI1_PASSTHRU_DESC);
...
#define G19 69
SIG_EXPR_DECL(SPI1CK, SPI1_MASTER, SPI1_MASTER_DESC);
SIG_EXPR_DECL(SPI1CK, SPI1_DEBUG, SPI1_DEBUG_DESC);
SIG_EXPR_DECL(SPI1CK, SPI1_PASSTHRU, SPI1_PASSTHRU_DESC);
...
#define C18 70
SIG_EXPR_DECL(SPI1MOSI, SPI1_MASTER, SPI1_MASTER_DESC);
SIG_EXPR_DECL(SPI1MOSI, SPI1_DEBUG, SPI1_DEBUG_DESC);
SIG_EXPR_DECL(SPI1MOSI, SPI1_PASSTHRU, SPI1_PASSTHRU_DESC);
...
SIG_EXPR_LIST_DECL_SINGLE(VBMOSI, VGABIOS_ROM, VB_DESC);
MS_PIN_DECL(C18, GPIOI6, SPI1MOSI, VBMOSI);

#define E20 71
SIG_EXPR_DECL(SPI1MISO, SPI1_MASTER, SPI1_MASTER_DESC);
SIG_EXPR_DECL(SPI1MISO, SPI1_DEBUG, SPI1_DEBUG_DESC);
SIG_EXPR_DECL(SPI1MISO, SPI1_PASSTHRU, SPI1_PASSTHRU_DESC);
...
SIG_EXPR_LIST_DECL_SINGLE(VBMISO, VGABIOS_ROM, VB_DESC);
MS_PIN_DECL(E20, GPIOI7, SPI1MISO, VBMISO);

FUNC_GROUP_DECL(SPI1_MASTER, B22, G19, C18, E20);
FUNC_GROUP_DECL(SPI1_DEBUG, B22, G19, C18, E20);
FUNC_GROUP_DECL(SPI1_PASSTHRU, B22, G19, C18, E20);
